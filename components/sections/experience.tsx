...
const entries = [
  {
    ...
    summary:  'Building game experiences and tools at BitByBit — a platform where developers create, share, and play custom game content. Responsibilities span gameplay systems engineering, tooling for content creators, and working across Unity and custom engine pipelines.',
    tags: [
